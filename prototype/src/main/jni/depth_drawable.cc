...
namespace tango_augmented_reality {
    ...
    DepthDrawable::DepthDrawable() {
        ...
        glVertexAttribPointer(attrib_texture_coords_, 2, GL_FLOAT, GL_FALSE, 0, nullptr);
        glBindBuffer(GL_ARRAY_BUFFER, 0);

        uniform_mvp_mat_ = glGetUniformLocation(shader_program_, "mvp");
    }

    void DepthDrawable::Render(const glm::mat4 &projection_mat, const glm::mat4 &view_mat) const {
